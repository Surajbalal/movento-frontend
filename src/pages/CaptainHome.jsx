...
function CaptainHome() {
  ...
  return (
    <div className="h-screen bg-gray-950 flex flex-col relative overflow-hidden font-sans">
      ...
      <div className="absolute top-0 left-0 right-0 z-30 pointer-events-none">
        <div className="p-3 sm:p-4 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 pointer-events-auto">
            ...
            {/* Desktop Profile Icon -> Opens menu */}
            <button
              onClick={() => setIsCaptainMenuOpen(true)}
              className="hidden md:flex w-11 h-11 bg-white/95 backdrop-blur-xl rounded-2xl shadow-[0_2px_20px_rgba(0,0,0,0.12)] border border-white/50 items-center justify-center hover:bg-white transition-colors cursor-pointer"
            >
              <i className="ri-user-3-line text-lg text-gray-700"></i>
            </button>

            {/* Mobile Hamburger Menu -> Opens menu */}
            <button
              onClick={() => setIsCaptainMenuOpen(true)}
              className="md:hidden w-11 h-11 bg-white/95 backdrop-blur-xl rounded-2xl shadow-[0_2px_20px_rgba(0,0,0,0.12)] border border-white/50 flex items-center justify-center hover:bg-white transition-colors cursor-pointer"
            >
      ...
      {/* ═══ RESUME RIDE BANNER — Ongoing rides ═══ */}
